...
<html>
  <head>
    ...
    <link rel="stylesheet" href="public/associate/css/estlistar.css" /> 
  ...
  <div class="estrutura">
          ...
          <nav>
            ...
            <div id="navbar-bottom">
              <div class="usu">
                ...
                <a href="combinacao"><span class="material-icons-sharp">checkroom</span>COMBINAÇÕES</a>
    ...
    <div class="content">
     ...
     <div id="indicator">
      ...
      <form action="{{ route('inativar.estilos') }}" method="POST">
