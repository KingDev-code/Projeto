...
<html>
  <head>
    ...
    <link rel="stylesheet" href="public/associate/css/dadospessoais.css" />
     ...
     <div id="indicator">
      ...
      <div class="tela">
        ...
        <input id="file-input" type="file" style="display: none;">
          ...
          <div class="forms">
            <a onclick="document.getElementById('file-input').click()"><img style="width:15%;" src="public/associate/img/dadospessoaisicon.png"></a>
