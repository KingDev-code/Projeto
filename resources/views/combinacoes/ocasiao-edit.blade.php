...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('public/associate/css/depalt.css') }}" />
  ...
  <div class="estrutura">
    ...
    <div class="content">
     ...
     <div id="indicator">
        <ul>
          ...
          <div id="arrow"></div>
          <li><a href="/editar-ocasioes{id}">ALTERAR DEPARTAMENTO</a></li>
        </ul>
      </div>
      <div class="tela">
    ...
    <section id="form">
      ...
      <form action="{{ route('ocasioes.update', ['id' => $ocasiao->id]) }}" method="post">
          @csrf
          @method('PUT') <!-- Método HTTP para atualização -->
          <h1>ALTERAR <br>OCASIÃO</h1>
          <div class="forms">
          <div class="form-group">
              <label for="ocasiao">Ocasião
                <input type="text" name="ocasiao" id="ocasiao" value="{{ $ocasiao->ocasiao }}" required>
              </label>
              <div class="btn2">
  ...
  <div class="pos-footer">
    ...
    <script src="associate/js/menu.js"></script>
  </body>
</html>
