...
<html>
  <head>
    ...
    <link rel="stylesheet" href="associate/css/depcad.css" />
  ...
  <div class="estrutura">
    ...
    <div class="content">
     ...
     <div id="indicator">
        <ul>
          ...
          <div id="arrow"></div>
          <li><a href="/ocasioes">CADASTRAR DEPARTAMENTO</a></li>
        </ul>
      </div>
      <div class="tela">
    ...
    <section id="form">
    <form action="{{ route('ocasioes.store') }}" method="post">
    @csrf
        <div class="forms">
            <h1>CADASTRAR <br> OCASIÃO</h1>
            <div class="form-group">
                <label>Ocasião
                    <input type="text" name="ocasiao" placeholder="Ocasião/Departamento" required>
                </label>
                <div class="btn2">
