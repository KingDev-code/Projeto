...
<html>
  <head>
    ...
    <link rel="stylesheet" href="public/associate/css/combalt.css" />
    ...
    <div class="content">
     ...
     <div id="indicator">
        <ul>
          ...
          <div id="arrow"></div>
          <li><a href="{{route('') }}">ALTERAR COMBINAÇÃO</a></li>
        </ul>
      </div>
      <div class="tela">
        ...
        <h3 class="lateralup">IMAGEM DA <br>COMBINAÇÃO</h3>
          ...
          <input id="file-input" type="file" style="display: none;">
                ...
                <h2>PEÇAS</h2>
                  ...
                  <div class="form-group">
                    <div class="btn2">
                    <button class="botaoregistrar">Salvar Alterações</button>
                    </div>
                  </div>
