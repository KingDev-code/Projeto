...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function checkScreenWidth() {
      if (window.innerWidth <= 710) {
          ...
          banner2.src = 'img/banner2-.png';
          banner3.src = 'img/banner3-.png';
          banner4.src = 'img/banner4-.png';
          banner5.src = 'img/banner5-.png';
      } else {
...
function exibirAlertasMasc() {
  Swal.fire({
    ...
    '<br><br><img src="img/m-medidas.svg" width=711px" height="284px"/><br><br><span>1° MEÇA A LARGURA DO SEUS OMBROS:</span> Posicione a fita métrica na lateral de um dos seus ombros e meça até encontrar a lateral inicial, unindo as extremidades da fita. Anote essa medida.'+
...
const inputOptions = new Promise((resolve) => {
  resolve({
    'Triângulo': '<img src="img/m-triangulo.svg" width="150" height="300"/><br>Quadris mais largos que os Ombros e a Cintura.',
    'Triângulo Invertido': '<img src="img/m-trianguloinvertido.svg" width="150" height="300"/><br>Ombros mais largos que os Quadris e a Cintura.',
    'Retângulo': '<img src="img/m-retangulo.svg" width="150" height="300"/><br>Ombros, Cintura e Quadris com larguras semelhantes.',
    'Trapézio': '<img src="img/m-trapezio.svg" width="150" height="300"/><br>Ombros e Cintura mais largos que o quadril.',
    'Oval': '<img src="img/m-oval.svg" width="150" height="300"/><br>Cintura mais larga que Ombros e Quadris.',
  })
})
...
Swal.fire({ 
  ...
  html: '<div class="html3"><br><div class="circle1"><h1>1</h1></div><div class="circle2"><h1>2</h1></div><div class="circle3"><h1>3</h1></div><br><br>'+
        ...
        '<br><img src="img/m-result1.png" width="auto" height="auto"/>'+
...
Swal.fire({ 
  ...
  html: '<div class="html3"><br><div class="circle1"><h1>1</h1></div><div class="circle2"><h1>2</h1></div><div class="circle3"><h1>3</h1></div><br><br>'+
        '<h4>RESULTADO</h4>'+
        `Provavelmente o seu tipo corporal é ...  ${corpo} `+
        '<br><img src="img/m-result2.png" width="auto" height="auto"/>'+
        '<p>Agora que você conhece o seu tipo de corpo, personalize suas escolhas no site e vista apenas o que realça a sua beleza!</p>'+
        '<p><span>"Lembre-se, não existe um tipo de corpo ideal! Priorize sentir-se bem e adequada ao seu estilo de vida e personalidade. Você é extraordinária!"<span></p>',
  customClass:{
        title:"titulo1",
